...
<div class="container">
    ...
    <div class="list-group" style="border:1px solid;border-radius:4px">
		...
		<h1 STYLE="text-align:center;margin-top:-5px" >Ricerca Aziende e Tirocini</h1>
			...
			<div class="row">
             ...
             <div class="col-md-3 col-sm-offset-1">
                    <div class="form-group">
                        <label for="lastname" class="control-label">Data di inizio</label>
                        <input type="text" class="form-control" id="lastname" placeholder="Inserisci...">
                    </div>
             </div> 
             ...
             <div class="col-md-3 col-sm-offset-1">
                    <div class="form-group">
                        <label for="lastname" class="control-label">Data di fine</label>
                        <input type="text" class="form-control" id="lastname" placeholder="Inserisci...">
                    </div>
             </div> 
