...
@WebServlet("/EliminazioneTirociniServlet")
public class EliminazioneTirociniServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
    Connection con = null;
    PreparedStatement ps = null;
  
    public EliminazioneTirociniServlet(){
        super();
    }
    ...
    // Metodo doGet per l'Eliminazione dei Tirocini.
   
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{

		String idTirocinio = request.getParameter("idTirocinio");
		String query = "DELETE FROM tirocinio WHERE idTirocinio='"+idTirocinio+"';";
