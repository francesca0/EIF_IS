...
public class AnnullamentoProgettoFormativoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(tipoAccount == 1){
			query = "UPDATE progetto_formativo SET annullato='1' WHERE approvazioneRa='1' AND firmaTaz='1' AND firmaTac='1' AND (firmaDd='1' OR firmaPcd='1') AND confermaUst='0' AND rifiutato='0' AND annullato='0' AND idProgettoFormativo='"+(String)request.getParameter("idProgettoFormativo")+"';";
		}
