...
public class ProgettoFormativo {
		...
		public ProgettoFormativo(String unIdProgettoFormativo, String unaMatricolaStudente, String unIdTirocinio, String unIdTaz, String unIdTac, String unIdRa, String unIdDd, String unIdPcd, int unaFirmaTaz,int unaApprovazioneRa, int unaFirmaTac, int unaFirmaDd, int unaFirmaPcd, int unaConfermaUst, String unNomeFile, int unRifiutato, int unAnnullato){
		...
		public String toString() {
			return "ProgettoFormativo [idProgettoFormativo=" + idProgettoFormativo + ", matricolaStudente="
					...
					+ ", idRa=" + idRa + ", idDd=" + idDd + ", idPcd=" + idPcd + ", firmaTaz=" + firmaTaz
